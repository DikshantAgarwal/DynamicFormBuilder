...
function UserForm({ onSubmit }) {
  const {form,error, handleChange, AddSkills,removeSkills, addPhoneNumber, setForm,handleSubmit,errorMessages ,skillInput,setSkillInput,runErrorChecks,isFormValid} = useUserForm(onSubmit);
